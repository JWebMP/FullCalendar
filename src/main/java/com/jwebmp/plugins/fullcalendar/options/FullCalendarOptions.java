        ...
        implements IDataComponent
{
    ...
    @JsonRawValue
    private List<FullCalendarPlugins> plugins;
    ...
    public FullCalendarOptions addPlugin(FullCalendarPlugins view)
    {
        getPlugins().add(view);
        return this;
    }

    public List<FullCalendarPlugins> getPlugins()
    {
        if (plugins == null)
        {
    ...
    public FullCalendarOptions setPlugins(List<FullCalendarPlugins> plugins)
    {
