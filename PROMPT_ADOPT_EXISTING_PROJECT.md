...
- Repository URL / local path: https://github.com/JWebMP/FullCalendar.git
- Org and project name: JWebMP / FullCalendar
- Short description: The JWebMP FullCalendar component
...
4. Create/Update project RULES.md (outside submodule):
  ...
  - Link to relevant topic indexes:
    - Frontend:
      ...
      - If JWebMP FullCalendar is selected: rules/generative/frontend/jwebmp/fullcalendar/README.md and its glossary; align option/view names to FullCalendar 6.1.19 and keep Angular artifacts read-only.
